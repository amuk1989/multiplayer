...
namespace Unity.Networking.Transport
{
    ...
    {
        internal const int k_defaultRxQueueSize = 3;
        internal const int k_defaultTxQueueSize = 3;
    ...
    public struct BaselibNetworkInterface : INetworkInterface
    {
        ...
        private const int k_defaultRxQueueSize = 3;
        private const int k_defaultTxQueueSize = 3;
